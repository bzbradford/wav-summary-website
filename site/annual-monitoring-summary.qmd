---
title: "2023 Monitoring Summary"
format:
  html:
    pagetitle: "2023 Monitoring Summary - Water Action Volunteers"
    toc: true
    echo: true
    code-fold: true
    warning: false
...
baseline %>%
  summarize(
    ...
    fieldworks = n_distinct(fieldwork_seq_no),
    .by = year) %>%
...
therm %>%
  summarize(
    min_day = as.Date("2022-12-31") + min(yday),
    max_day = as.Date("2022-12-31") + max(yday),
