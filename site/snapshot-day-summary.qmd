...
*For each of the following, AIS identifications have been categorized as either new to the location that year, or a confirmation of a species already found at the site in a prior year.*
...
*Unique watersheds are identified by their WBIC. Note that some sampling points were missing WBICs; these are enumerated at the end of this report. For the purposes of counting waterbodies, sites missing WBICs have all been assumed to be from different WBICs from any other station in the dataset.*
